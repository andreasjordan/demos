...
As `sp_Blitz @OutputType = 'markdown'` excludes all the security findings, I wanted to convert the T-SQL code from inside of sp_Blitz into PowerShell and make it even more flexible.



Here is the T-SQL code:
https://github.com/BrentOzarULTD/SQL-Server-First-Responder-Kit/blob/99c3073b26d255fde928ef0e3076e7600e687596/sp_Blitz.sql#L9375-L9395
...
Have fun with the code. Feedback is welcome.
