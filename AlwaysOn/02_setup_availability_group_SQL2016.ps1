[CmdletBinding()]
param (
    [string[]]$SqlInstances = @('SQL01\SQL2016', 'SQL02\SQL2016'),
    [string]$BackupPath = '\\fs\Backup',
    [string]$DatabaseName = 'AdventureWorks',
    [string]$AvailabilityGroupName = 'AdventureSQL2016',
    [System.Net.IPAddress]$AvailabilityGroupIP = '192.168.3.73',
    [string[]]$EndpointUrls = @('TCP://192.168.3.31:5025', 'TCP://192.168.3.32:5025')
)
...
$availabilityGroupParameters = @{
    ...
    Port               = 24330                 # This is only needed if you have also run the 02_setup_availability_group.ps1 - as the other availability group already uses port 1433
